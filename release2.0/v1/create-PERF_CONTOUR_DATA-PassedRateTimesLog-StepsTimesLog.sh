...
perftestname=('output-PERF_CONTOUR_DATA_Mode2') # 'PERF_CONTOUR_DATA' 'PERF_CUBE_HISTOGRAM' 'PERF_REGION_SPECTRAL_PROFILE' 'PERF_ANIMATION_PLAYBACK')
# lenperftest="${#perftestname[@]}"
ImageName=('smoothingMode of 2')
# 'smoothingMode of 0' 'smoothingMode of 1') # 'cube_A_04800_z00100.fits' 'cube_A_09600_z00100.fits' 'cube_A_19200_z00100.fits' 'cube_A_02400_z00100.image' 'cube_A_04800_z00100.image' 'cube_A_09600_z00100.image' 'cube_A_19200_z00100.image' 'cube_A_02400_z00100.hdf5' 'cube_A_04800_z00100.hdf5' 'cube_A_09600_z00100.hdf5' 'cube_A_19200_z00100.hdf5')
# echo "${#ImageName[@]}"
...
perftestname=('output-PERF_CONTOUR_DATA_Mode0') # 'PERF_CONTOUR_DATA' 'PERF_CUBE_HISTOGRAM' 'PERF_REGION_SPECTRAL_PROFILE' 'PERF_ANIMATION_PLAYBACK')
# lenperftest="${#perftestname[@]}"
ImageName=('smoothingMode of 0')
# 'smoothingMode of 0' 'smoothingMode of 1') # 'cube_A_04800_z00100.fits' 'cube_A_09600_z00100.fits' 'cube_A_19200_z00100.fits' 'cube_A_02400_z00100.image' 'cube_A_04800_z00100.image' 'cube_A_09600_z00100.image' 'cube_A_19200_z00100.image' 'cube_A_02400_z00100.hdf5' 'cube_A_04800_z00100.hdf5' 'cube_A_09600_z00100.hdf5' 'cube_A_19200_z00100.hdf5')
# echo "${#ImageName[@]}"
...
perftestname=('output-PERF_CONTOUR_DATA_Mode1') # 'PERF_CONTOUR_DATA' 'PERF_CUBE_HISTOGRAM' 'PERF_REGION_SPECTRAL_PROFILE' 'PERF_ANIMATION_PLAYBACK')
# lenperftest="${#perftestname[@]}"
ImageName=('smoothingMode of 1')
# 'smoothingMode of 0' 'smoothingMode of 1') # 'cube_A_04800_z00100.fits' 'cube_A_09600_z00100.fits' 'cube_A_19200_z00100.fits' 'cube_A_02400_z00100.image' 'cube_A_04800_z00100.image' 'cube_A_09600_z00100.image' 'cube_A_19200_z00100.image' 'cube_A_02400_z00100.hdf5' 'cube_A_04800_z00100.hdf5' 'cube_A_09600_z00100.hdf5' 'cube_A_19200_z00100.hdf5')
# echo "${#ImageName[@]}"
...
cat output-PERF_CONTOUR_DATA_Mode2-PassedRateTimesLog.txt output-PERF_CONTOUR_DATA_Mode0-PassedRateTimesLog.txt output-PERF_CONTOUR_DATA_Mode1-PassedRateTimesLog.txt > output-PERF_CONTOUR_DATA-PassedRateTimesLog.txt
cat output-PERF_CONTOUR_DATA_Mode2-Step1TimesLog.txt output-PERF_CONTOUR_DATA_Mode0-Step1TimesLog.txt output-PERF_CONTOUR_DATA_Mode1-Step1TimesLog.txt > output-PERF_CONTOUR_DATA-Step1TimesLog.txt
cat output-PERF_CONTOUR_DATA_Mode2-Step2TimesLog.txt output-PERF_CONTOUR_DATA_Mode0-Step2TimesLog.txt output-PERF_CONTOUR_DATA_Mode1-Step2TimesLog.txt > output-PERF_CONTOUR_DATA-Step2TimesLog.txt
